...
include("inc/header.php"); ?>
	...
	<div id="content-wrapper">
	 <div id="banner">
	  ...
	  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="850" 
		 height="298"> 
		 <param name="movie" value="UPCbanner.swf"> 
		 <param name="quality" value="high"> 
		 <embed src="UPCbanner.swf" quality="high" 
	 ...
	 <div id="content-area">
		 <div id="homepage-events">
		 	<!--<img src="images/events-label.jpg" class="home-header bottom-padding-20" alt="events" />-->
	  		<h1>Events</h1>
			 <div id="sub-wrapper">
				 <div class="sub bottom-padding-20">
				 <a target="_blank" href="http://www.ticketmaster.com/event/0000448EF2629CB1?artistid=735024&majorcatid=10001&minorcatid=1"><img src="images/etheridge-3sm.jpg" alt="Melissa Etheridge" class="white-border" width="300" height="280" /></a>
				 	<div>&nbsp;</div>
				 	<p class="home-band"><a target="_blank" href="http://www.ticketmaster.com/event/0000448EF2629CB1?artistid=735024&majorcatid=10001&minorcatid=1" class="float-left">Melissa Etheridge&nbsp;&nbsp;<span class="yellow">July 14</span></a></p>
				 	<!--<a target="_blank" href="http://www.ticketmaster.com/event/0000448EF2629CB1?artistid=735024&majorcatid=10001&minorcatid=1"><p class="yellow bigger">July 14</p></a>-->
				 	<a target="_blank" href="http://www.ticketmaster.com/event/0000448EF2629CB1?artistid=735024&majorcatid=10001&minorcatid=1"><p class="bigger clear-float">On Sale Now!</p></a>	
				 </div>
			 </div><!--sub wrapper-->
			 <div id="ads">
	 ...
	 <!--<img src="images/welcome.jpg" class="home-header" alt="welcome" />-->
	 <h1>Welcome</h1>
	 ...
	 <a href="./rentals.html" title="United Palace Rentals"><h1 class="top-margin-20">United Palace Concerts is now accepting rental reservations for public or private use</h1></a><!-- STAYS-->
		...
		<!--<img src="images/production-house-lowres.jpg" alt="JAB II Production Company" class="float-right top-margin-20 left-margin-20" width="212" height="141" />-->
	...
	<a href="live-production.html" title="Live Event Productions"><h1 class="top-margin-20">Our Full-Service Production Company will make your event a guaranteed success!</h1></a>
		...
		<p>Whether you're organizing an event for 100 or 100,000, in New York, Chicago, Los Angeles and all points in between - JAB II, a national, full-service production company can handle everything including labor, ticket collection, merchandise sales, security, ushers, stage hands and loaders, concessions, transportation, staging, rigging, lighting, sound, transportation, catering and marketing. Find out how easy it is to let JAB II handle all your live production services. Call or email us today to make your event a complete success!</p> 
		
		<p class="white">JAB II LLC.<br /> 
		Live Event Product Company Information<br /> 
		212-496-7490<br /> 
		<a href="mailto:events@unitedpalaceconcerts.com">events@unitedpalaceconcerts.com</a> 
		</p> 

	 </div>
	 </div><!--content area-->
	 
	 <img src="images/sponsors.jpg" title="Our Sponsors" style="margin-left:220px;" class="top-margin-20" />
 
	 <!--Are you editing below this line?  Are you sure about that?-->
